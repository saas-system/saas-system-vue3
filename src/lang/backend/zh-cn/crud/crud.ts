export default {
    ...
    'Target namespace help': '选择生成代码的目标命名空间，如平台后台(admin)或租户后台(tenant)',
    'Namespace Admin': '平台(Admin)',
    'Namespace Tenant': '租户(Tenant)',
    'Add and modify interface method': '增加和修改界面方式',
    'Add and modify interface method help': '新增/编辑时使用弹窗(PopupForm)或抽屉(DrawerForm)',
