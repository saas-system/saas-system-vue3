export default {
    ...
    'Target namespace help': 'Select the target namespace for generated code (e.g. admin or tenant)',
    'Namespace Admin': 'Admin',
    'Namespace Tenant': 'Tenant',
    'Add and modify interface method': 'Add and modify interface method',
    'Add and modify interface method help': 'Use PopupForm (dialog) or DrawerForm (drawer) for add/edit',
